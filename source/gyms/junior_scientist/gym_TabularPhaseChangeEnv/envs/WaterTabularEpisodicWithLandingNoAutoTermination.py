...
class WaterTabularEpisodicWithLandingNoAutoTermination(gym.Env):
    def __init__(self):
        self.action_space = gym.spaces.Discrete(3) #Move left, try to land, move right
    ...
    def step(self, action):
        ...
        if action == 0 and self.stateID > 0:
            ...
            if self.atGoal():
                ...
                self.stateID = np.max(self.stateID - 5, 0)
